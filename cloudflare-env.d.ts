/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 67a5310ecac0f3d5eeea00eca1f42871)
// Runtime types generated with workerd@1.20250422.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		OG_IMAGE_CACHE: KVNamespace;
		R2_DOMAIN: "og-image-store.r2.cloudflarestorage.com";
		ACCESS_SECRET: "ACCESS_SECRET";
		NEXTJS_ENV: string;
		OG_IMAGE_STORE: R2Bucket;
		ASSETS: Fetcher;
	}
}
